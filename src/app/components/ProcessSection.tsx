...
const steps = [
    { number: '01', title: 'Discover', desc: 'Understand your business goals, users and constraints before touching a design tool.' },
    { number: '02', title: 'Define', desc: 'Scope, architecture and a clear project brief so everyone knows what we are building and why.' },
    { number: '03', title: 'Design', desc: 'Visual systems, components and prototypes reviewed with stakeholders before development begins.' },
    { number: '04', title: 'Build', desc: 'Clean, tested code with regular milestone reviews and a staging environment throughout.' },
    { number: '05', title: 'Launch', desc: 'Deployment, monitoring and handover documentation so your team can operate independently.' },
    { number: '06', title: 'Grow', desc: 'Post-launch analytics, iteration and ongoing support to keep improving after you ship.' },
];
            ...
            <div className="container-page">
                ...
                <div className="hidden lg:grid lg:grid-cols-6 gap-0 border border-mist rounded-lg overflow-hidden">
                    ...
                    style={{ transitionDelay: `${i * 60}ms` }}
                        >
                    <span className="font-inter text-ember-orange text-xs font-medium">{step?.number}</span>
                    <h3
            ...
            <div className="lg:hidden flex flex-col border border-mist rounded-lg overflow-hidden">
                {steps?.map((step, i) => (
                    <div
                        ...
                        >
                <span className="font-inter text-ember-orange text-sm font-medium flex-shrink-0 w-8">{step?.number}</span>
                <div>
                    <h3
