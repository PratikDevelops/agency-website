      ...
      <div className="container-page">
        <div className="bg-graphite rounded-lg p-12 lg:p-20 relative overflow-hidden noise-overlay">
          ...
          <div
            ...
            style={{
              background: 'radial-gradient(circle, rgba(255,104,44,0.08) 0%, transparent 70%)',
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
            <div className="reveal max-w-lg">
              ...
              >
                Tell us what you are building and we will put together a proposal within 48 hours.
