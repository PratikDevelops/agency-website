      ...
      <div className="container-page">
            ...
            <div className="lg:col-span-7 p-8 lg:p-12 flex flex-col justify-between section-canvas">
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <span
                    className="font-inter text-slate text-sm"
                ...
                <p
                  className="font-inter text-steel leading-relaxed mb-6"
                  style={{ fontSize: '15px' }}
                >
                  Websites, platforms and web applications built for performance, conversion and
                  scale. From marketing sites to complex SaaS products.
                </p>
                <div className="flex flex-wrap gap-2 mb-8">
                  {['Marketing Sites', 'E-commerce', 'Web Apps', 'CMS', 'Performance']?.map(
                    (cap) => (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-mist border border-mist rounded-lg overflow-hidden">
          {services?.slice(1)?.map((service, i) => (
            <div
              key={service?.slug}
              className="reveal section-canvas p-6 flex flex-col gap-3 hover:bg-ash transition-colors duration-200"
            >
