...
export const metadata: Metadata = {
    ...
    description: 'Nine digital disciplines under one roof - web development, app development, SEO, graphic design, UI/UX, video editing, ad marketing, social media and automation.',
    openGraph: {
        title: 'Services - AgencyStudio',
