            ...
            <div className="container-page">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {packages.map((pkg, i) => (
                        <div
                            key={pkg.name}
                            className={`reveal flex flex-col p-8 border ${pkg.popular
                                ? 'border-graphite bg-graphite text-white' : 'border-mist bg-canvas'
                                }`}
                        ...
                        >
                            ...
                            <Button
                                ...
                                className={pkg.popular ? 'border-white text-white hover:bg-white hover:text-graphite' : ''}
                            >
                                Start with {pkg.name}
                            </Button>
                        </div>
