      ...
      <div className="container-page">
        <div className="max-w-3xl">
          ...
          <p
            ...
            style={{ fontSize: '18px' }}
          >
            Nine digital disciplines. One focused team. From the first strategy session to
            post-launch growth - we handle every part of the digital stack so you don&apos;t have to
