...
export default function ContactInfo() {
    return (
        <div className="flex flex-col gap-8">
            <div>
                <h2 className="font-polysans text-graphite mb-6" style={{ fontSize: '24px', letterSpacing: '-0.02em', fontWeight: 400 }}>
                    Get in touch
                </h2>
    ...
    <div className="asymmetric-card p-8">
        <p className="font-polysans text-graphite mb-2" style={{ fontSize: '18px', letterSpacing: '-0.02em', fontWeight: 400 }}>
            Prefer a call?
        </p>
        ...
        >
            ...
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M2.5 7h9M8 3.5l3.5 3.5L8 10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
        </a>
    </div>
